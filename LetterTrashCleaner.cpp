...
{
    LetterTrashCleaner::LetterTrashCleaner(const cv::Mat& labelImage, const float& areaMax)
        : labelImage_(labelImage), areaMax_(areaMax),
            resultImage_(cv::Mat(Size(labelImage.cols, labelImage.rows), CV_8UC1, Scalar::all(0)))
    {
